...
export function toFeatureKey(moduleName, featureName) {
...
export async function getPlanFeatures(planId) {
  ...
  `.then((result) => result.recordset);
    ...
    const mapped = rows
        .map((row) => String(row.feature_key || ""))
...
export async function getTenantAllowedFeatures(tenantId) {
...
export async function setPlanFeatures(planId, featureKeys) {
...
export async function setRolePermissions(tenantId, role, featureKeys) {
